...
$emailConfig = [
    ...
    'password' => 'senha', // Use uma senha de aplicativo se a verificação em duas etapas estiver ativada
    'port' => 587,
...
try {
  ...
  <head>
      <style>
          ...
          .content h1, .content h2, .content h3 { color: #333; margin-top: 20px; }
          ...
          a { color: #7a5af7; text-decoration: none; }
          a:hover { text-decoration: underline; }
          ul, ol { padding-left: 20px; }
          li { margin-bottom: 10px; }
          br { margin-bottom: 10px; display: block; }
      </style>
  </head>
  <body>
      <div class='container'>
